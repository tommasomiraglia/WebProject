            ...
            <ul class="list-unstyled">
                ...
                <li class="card rounded-4 border shadow-sm my-3">
                    <div class="card-body d-flex justify-content-between align-items-center">
                        <a href="user.php?userId=<?php echo $user["userId"];?>" class="d-flex align-items-center text-decoration-none text-dark">
                            <img src="../<?php echo $user["avatar"];?>" alt="" class="rounded-circle me-2 object-fit-cover"
                                width="40" height="40" />
